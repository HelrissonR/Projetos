...
const linhas = [
  ...
  `"2026";"1234";"SP";"7";"DEPUTADO ESTADUAL";"800003";"33333";"OUTRO NOME";"OUTRO";"ABC";"";"DEFERIDO"`, // cargo 7 agora é incluído
...
assert.strictEqual(cands.length, 3, "inclui majoritários + deputados, sem duplicados");

const dep = cands.find((c) => c.id === "800003");
assert.strictEqual(dep.cargo, "Deputado Estadual");
